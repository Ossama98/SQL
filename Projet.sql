...
-- Indexes EMPRUNT
DROP INDEX IDX_UNIQUE_EMPRUNT_DATE_START;
DROP INDEX IDX_UNIQUE_EMPRUNT_DATE_END;
...
--Indexes ADHERENT
DROP INDEX IDX_UNIQUE_ADHERENT_NOM;
DROP INDEX IDX_UNIQUE_ADHERENT_VILLE;
DROP INDEX IDX__BIBLIOTHEQUE_NESTED_TABLE_ID;
